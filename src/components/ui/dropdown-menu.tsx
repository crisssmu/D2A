  ...
  "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
  {
    variants: {
      variant: {
        ...
        normal: "hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50 dark:hover:text-accent-foreground",
      },
  },
    defaultVariants: {
      variant: "default",
...
function DropdownMenuItem({
  ...
  inset?: boolean
  variant?: VariantProps<typeof dropMenuItemVariants>["variant"]
}) {
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(dropMenuItemVariants({ variant, className }))}{...props}
    />
  )
}
